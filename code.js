...
function getAuditDashboard() {
  try {
    ...
    return successResponse_({
      ...
      certifiedStations: core.evaluated.filter(s => s.isCertified && !s.isOutsourced).sort(byName),
      normalStations: core.evaluated.filter(s => !s.isCertified && !s.isOutsourced).sort(byName),
      outsourcedStations: core.evaluated.filter(s => s.isOutsourced).sort(byName),
